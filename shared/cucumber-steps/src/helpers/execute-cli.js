...
exports.executeCLI = void 0;
var make_full_path_1 = require("./make-full-path");
var observable_process_1 = require("observable-process");
/**
 ...
 */
function executeCLI(command, expectError, world, opts) {
    if (opts === void 0) { opts = {}; }
    return __awaiter(this, void 0, void 0, function () {
        var args, fullCommand, runner;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fullCommand = make_full_path_1.makeFullPath(command, process.platform);
                    runner = observable_process_1.createObservableProcess(fullCommand, args);
                    return [4 /*yield*/, runner.waitForEnd()];
                case 1:
                    _a.sent();
