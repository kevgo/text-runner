Feature: creating directories
  ...
  Scenario: setting the base directory
    Given the source code contains a file "creator.md" with content:
      """
      Create a directory <a type="workspace/new-directory" dir="subdir">directory_name</a>.
      """
    When calling Text-Runner
    Then it emits these events:
      | FILENAME   | LINE | ACTION                  | ACTIVITY                               |
      | creator.md | 1    | workspace/new-directory | create directory subdir/directory_name |
